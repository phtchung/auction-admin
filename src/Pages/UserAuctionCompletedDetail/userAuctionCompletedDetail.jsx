import {billChangeStatus, convertWinStatus, formatDateTime} from "../../Utils/constant.js";
                        ...
                        <>
                            ...
                            <div className="m-10 font-sans font-normal bg-white mb-10">
                                ...
                                <div
                                    ...
                                    <div className="col-start-5 text-left col-span-2 ...">{reqData?.seller?.average_rating ? reqData?.seller?.average_rating : 0}</div>
                                </div>
                                <div
                                    className="grid grid-rows-1 grid-cols-6 grid-flow-col gap-4 border-b-2 p-3 ">
                            ...
                            <div className="grid grid-cols-3 bg-white pt-8 gap-4 m-10 ">
                                ...
                                <div className="text-sm text-left font-light text-neutral-600 mx-6 relative ">
                                    <div
                                        className="text-base font-semibold mr-10 bg-amber-200 left-0 h-8 w-44 bottom-5 p-1 px-4 absolute">
                                        {reqData?.updatedAt}
                                    </div>
