...
import {adminChangeStateRequestFromUser, formatMoney} from "../../Utils/constant.js";
    ...
    return (
        <>
            ...
            <div className="items-center font-medium text-sm gap-6 my-8 mx-8 px-1 space-y-6 ">
                ...
                <div className="grid grid-cols-6 text-left">
                    <div> Hình thức đấu giá :</div>
                    <div
                        className="font-normal underline  col-span-5"> {data?.auction_live}</div>
                </div>
                ...
                <div className="grid grid-cols-6 text-left">
                    ...
                    <div className="font-normal  col-span-2"> {data?.seller?.shop_point || 0}</div>
                </div>
                <div className="grid grid-cols-6 text-left">
